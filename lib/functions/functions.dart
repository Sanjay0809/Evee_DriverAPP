...
import 'package:flutter_driver/pages/login/otp_page.dart';
...
//base url
String url =
    'https://evee.in/public/'; //add '/' at the end of the url as 'https://url.com/'
...
geolocs.LocationSettings locationSettings = (platform == TargetPlatform.android)
    ? geolocs.AndroidSettings(
        ...
        foregroundNotificationConfig:
          ...
          notificationText:
              "XCash Driver will continue to receive your location in background",
